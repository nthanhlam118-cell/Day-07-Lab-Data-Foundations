...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        while i < len(text):
            current += text[i]
            if (current.endswith(". ") or current.endswith("! ") or 
                current.endswith("? ") or current.endswith(".\n")):
        ...
        for j in range(0, len(sentences), self.max_sentences_per_chunk):
            chunks.append(" ".join(sentences[j:j+self.max_sentences_per_chunk]))
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        if sep in current_text:
            ...
            return self._split(current_text, new_separators)
